        ...
        try {
            for (Object value : values) {
                if (value instanceof String) {
                    ...
                    preparedStatement.setTimestamp(counter, Timestamp.valueOf(((LocalDate) value).atStartOfDay()));
                }  else {
                    throw new EoInternalException(
                        "Unsupported type " + value.getClass() + " " + counter + " - " + value);
                }
                counter++;
            }
        ...
        try {
            ...
            try {
                ...
                throw new EoException(
                    "Exception get resultSet for sql " + statement.toString() + ": " + e.getMessage());
            }
        } catch (SQLException e) {
