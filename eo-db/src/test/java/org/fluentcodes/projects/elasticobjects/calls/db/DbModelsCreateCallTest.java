...
public class DbModelsCreateCallTest {
    ...
    public void H2Mem_create() {
        ...
        assertEquals("CREATE DATABASE: \n" +
                ...
                "Create table AnObject (id bigint not null , myASubObject_id bigint, myAnObject_id bigint, myBoolean boolean, myDate date, myDouble double, myFloat float, myInt integer, myLong bigint, myString varchar(20), naturalId varchar(80) not null ): 0\n" +
                "Alter table AnObject add unique   (id): 0\n" +
                "Alter table AnObject add unique   (naturalId): 0\n" +
                "Create table ASubObject (id bigint not null , myASubObject_id bigint, myString varchar(20), name varchar(80), naturalId varchar(80) not null ): 0\n" +
